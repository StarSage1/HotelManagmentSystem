...
public class WaiterForm extends javax.swing.JFrame {
  ...
  jTextField4.setText(x);
              b.add(W);   
                  try(FileWriter fw=new FileWriter("waiter.data",true))
            {
                fw.write("overtime : "+over+"\n"+"deduction : "+deduction+"\n"+"address : "+address+"\n"+"id : "+id+"\n"+"name : "+name+"\n"+"nationaltyid : "
                        +nationaltyid+"\n"+"number : "+number+"\n"+"nationalty : "+nathonalty+"\n"+"email : "+email+"\n"+"age : "
                        +age+"\n"+"gender : "+gender+"\n"+"total_salary :"+W.GetTotalSalary(over, deduction));
            }
            catch(Exception e)
            {
